...
{
   var getshorturl=0;
   var login = "o_32ma126lud";
   var api_key = "R_f76d0b39051b40049e7a400deffdff06";
   var long_url = "https://roselist.github.io/index.html?list="+ shoppinglist;
  try{
  $.getJSON(
...
function savecookie()
{
  delete_cookie('roselist');
   var date = new Date();
   //keeps for a year
    date.setTime(date.getTime() + Number(365) * 3600 * 1000);
   document.cookie = 'roselist' + "=" + escape(shoppinglist.join(',')) + "; path=/;expires = " + date.toGMTString();
}
